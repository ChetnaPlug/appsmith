...
const datepickerContent = `(function(root, factory) {
...
fs.writeFileSync(path.join(__dirname, '../dist/datepicker-bundle.js'), datepickerContent);
console.log('✓ datepicker-bundle.js created');